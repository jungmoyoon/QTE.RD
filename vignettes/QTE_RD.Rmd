...
So far, we have illustrated using a discrete covariate, but continuous variables — or a combination of both discrete and continuous covariates — can also be incorporated. For more details, please refer to @Qu_Yoon_2025.
